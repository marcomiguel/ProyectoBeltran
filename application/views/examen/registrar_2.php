                ...
                'Agregar':function(){   
                    ...
                    if($('#get_idIndicador').attr('data-isorina')==1){
                        for(var i=1;i<=5;i++){
                            ...
                            //itemDetail.nameExamen= unique(name_miArray); 
                            itemDetail.idIndicadores= indIndicadores; 
                            //itemDetail.idIndicadores= unique(name_miArray); 
                            ...
                            /******************/
                            //    console.log('nombreExamenOrina1',itemDetail.idIndicadores);
                            //itemDetail.idIndicadores = [];
                            iCountItem++;
                            iCountItemInd=0;
                            reinitiarObject(ind_arrayDetails);
                            //reinitiarObject(itemDetail);
                            itemDetail = [];
                            indIndicadores = "";
                            //reinitiarObject(itemDetail);
                            nombreExamenOrina = "";
                            ...
                            //ind_miArray = [];
                            //name_miArray = [];
                            //   console.log('nombreExamenOrina2',itemDetail.idIndicadores);
