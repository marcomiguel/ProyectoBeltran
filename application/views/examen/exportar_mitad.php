...
$data.="<tr>";
$data.="<td width=\"33%\" style=\"font-size:14px; color:#5dbb50; text-align:left; font-weight:bold;\">LABORATORIO \"BELTRAN\"</td>";
$data.="<td width=\"7%\"></td>";
$data.="<td width=\"30%\" style=\"font-size:11px; color:#0068A4;\">Jr. Ayacucho N° 358 Of. 3-4 TRUJILLO</td>";
$data.="</tr>";
$data.="<tr>";
$data.="<td style=\"text-align:left; margin-left:40px;\"><img src=\"http://localhost/proyecto_beltran/images/microscopy_80.png\" alt=\"Lab. Beltran\"/></td>";
$data.="<td></td>";
$data.="<td style=\"text-align:center;\"><img src=\"http://localhost/proyecto_beltran/images/logo_beltran_90.png\" alt=\"Logo Lab. Beltran\"/></td>";
$data.="</tr>";
$data.="<tr>";
$data.="<td style=\"color:#ed2991; font-size:11px; text-align:center;\">Analisis Clínicos Microbilógicos</td>";
$data.="<td></td>";
$data.="<td rowspan=\"2\"><table border=\"0\"><tr><td style=\"font-size:11px; color:#0068A4; text-align:center;\">Telf. 044 233317 - Cel. 949714367</td></tr><tr><td style=\"font-size:12px; color:#0068A4; text-align:left;\">E-mail: beltran121@hotmail.com</td></tr></table></td>";
$data.="</tr>";
$data.="<tr>";
$data.="<td style=\"color:#0068A4; font-size:12px; text-align:center;\">Su majestad el Paciente</td>";
$data.="<td></td>";
$data.="<td></td>";
$data.="</tr>";
$data.="</table>";
...
$data.="<br/>";
$data .= "<table border=\"0\"  id=\"hor-zebra-med\" rules=\"none\" summary=\"Employee Pay Sheet\" cellspacing=\"0\" cellpadding=\"0\" style=\"float:left; width:420px;\">";
...
$data.="<table style=\"width:430px; margin: 1px;\" border=\"0\">";
$data.= "<tr><td  style=\"margin:7px; font-size:13px; font-family: 'arial', serif; color:#3B5998; text-align:center; font-weight:bold;\">RESULTADOS DE ANALISIS</td></tr>";
$data.="</table>";

$data.="<table border=\"0\" id=\"t-results\" style=\"width:430px; font-size:12px; font-family: 'arial', serif; margin:0px;\"cellspacing=\"0\" cellpadding=\"0\">";
...
$data.="<table style=\"width:430px;\" border=\"0\">";
$data.= "<tr><td colspan=\"2\" style=\"font-size:11px; font-family: 'Lucida Sans Unicode', 'Lucida Grande', Sans-Serif; padding:0px; margin-left:0px; text-align:left; \">Trujillo, 28 de mayo del 2012</td></tr>";
$data.= "<tr><td colspan=\"2\" style=\"font-size:13px; margin-right:0px; text-align:right; \">------------------------------------</td></tr>";
$data.="<tr><td colspan=\"2\" style=\"font-size:10px; margin-right:10px; padding:0px; text-align:right; \">Dr. JOSÉ MANUEL BELTRAN MORALES</td></tr>";
$data.="<tr><td colspan=\"2\" style=\"font-size:10px; margin-right:80px; padding:0px; text-align:right; \">CBP: 0972</td></tr>";
$data.="</table>";
